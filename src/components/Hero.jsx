...
const Hero = () => {
  ...
  return (
    <div ref={containerRef} className="bg-bg-color h-auto lg:min-h-screen text-black relative overflow-hidden">
        ...
        <section className=" flex flex-col pt-20 lg:pt-30 lg:px-10 md:h-[70%] lg:h-screen text-center gap-5 justify-center items-center wrapper">
            <div className="flex flex-col lg:gap-6 w-full relative">
              <div className="flex flex-col md:gap-3 text-left md:pt-10 lg:overflow-hidden">
                <span ref={textItem1} className="text-[3.1rem] md:text-[7rem] lg:text-[9.5rem] font-bricolage leading-10 mt-3 font-bold lg:text-left lg:leading-24">Good Designs</span><br /> 

                <span ref={textItem3} className="text-[3.1rem] md:text-[7rem] md:mt-6 lg:text-[9.5rem] font-bricolage leading-10 font-bold lg:text-right lg:leading-24">Make Great</span><br />

                <span ref={textItem2} className="text-[3.1rem] md:text-[7rem] md:mt-6 lg:text-[9.5rem] font-bricolage leading-10  font-bold lg:text-left lg:leading-24">Business</span>
