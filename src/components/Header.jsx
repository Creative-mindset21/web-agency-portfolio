...
const Header = () => {
  ...
  return (
    <header className=' bg-bg-color text-white relative font-poppins'>
      <div className='flex p-5 items-center justify-between wrapper'>
        ...
        <nav className={`fixed top-0 ${menuOpen ? "left-0" : "left-[-1000%]"} bg-white text-nav-color w-[80%] shadow-2xl text-2xl md:text-4xl lg:hidden transition-all`} style={{transition: "all 1s ease-in-out"}}>
